...
そのため、GA4の流入（結果）だけでなく、STEP1で使った質問を定期的に投げ直して**言及率や推薦順位（原因）もあわせて記録**します。効果測定の具体的なやり方は、別記事の「[AI検索対策の効果はどう測る？GA4でAI流入を見る方法](/media/ai-search-measurement/)」で詳しく解説しています。
